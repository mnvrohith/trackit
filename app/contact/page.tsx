...
const ContactPage = () => {
  ...
  Need help?{' '}
  <span>
    Send us an email at <span className="font-bold">support@trackit.com</span> and we’ll get back to you within 24 hours.
  </span>
</span>
                ...
                <div className='mt-4 p-3 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg'>
                  <p className='text-xs sm:text-sm text-emerald-700 dark:text-emerald-300'>
                    <strong>Note:</strong> Available 24/7 with
            ...
            <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100/50 dark:border-gray-700/50'>
              ...
              <div className='space-y-3'>
                ...
                <div className='p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg'>
                  ...
                  <p className='text-xs text-gray-600 dark:text-gray-400'>
                   Just click the button in the Expense Description, TrackIt AI automatically sorts them using AI insights.
                  </p>
                </div>
                <div className='p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg'>
                  <h4 className='font-semibold text-gray-900 dark:text-gray-100 text-xs sm:text-sm mb-1'>
                    How can I get help with AI features?
                  </h4>
                  <p className='text-xs text-gray-600 dark:text-gray-400'>
                    Click Refresh Insights button in AI Insights section.
                  </p>
                </div>
              </div>
            </div>
